...
int bio_enroll_by_capture(char *enrollID,int time_out_period,unsigned char quality);
...
int bio_enroll_by_template(char *enrollID,char *template_data, int template_len);
...
int bio_capture_template(char *template_file,int time_out_period,unsigned char quality);
...
int bio_get_template(char *enrollID, char *template_file);
...
int bio_capture_image(char  imageFormat, char imageType, char *image_file_name, int time_out_period, unsigned char *imgData, int *imgSize);
...
int bio_verify_by_capture(char *enrollID, int time_out_period);
...
int bio_verify_host_template_file_by_capture(char *template_file_name,int time_out_period);
...
int bio_identify_by_capture(char *enrollID,int time_out_period);
...
int bio_delete_template(char *enrollID);
